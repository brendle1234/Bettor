...
def xgb_runner(data, todays_games_uo, frame_ml, games, home_team_odds, away_team_odds, kelly_criterion):
    ...
    for game in games:
        ...
        print(home_team + ' EV: ' + str(ev_home) + (bankroll_fraction_home if kelly_criterion else ''))
        print(away_team + ' EV: ' + str(ev_away) + (bankroll_fraction_away if kelly_criterion else ''))
        count += 1
